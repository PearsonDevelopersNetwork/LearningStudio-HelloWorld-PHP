...
class OAuth2Request{
   ...
   * @access public
   * @return integer $creationTime Milliseconds since epoch
   */
   ...
   * @access public
   * @param integer $creationTime Milliseconds since epoch
   */
  ...
  public function getExpirationTime () {
    ...
    return $this->creationTime + ($this->expiresInSeconds * 1000);
  }
}
